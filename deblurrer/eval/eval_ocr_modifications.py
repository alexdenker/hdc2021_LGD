...
for version in range(8, 22):
    step = 15
    identifier = "last" # "epoch"
    ...
    base_path = "/localdata/AlexanderDenker/deblurring_experiments/modifications"
    ...
    print("Load reconstructor from: ", chkp_path)
